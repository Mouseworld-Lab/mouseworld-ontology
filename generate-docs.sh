...
echo "Step 1. Exporting drawio diagrams to multiple formats"
...
echo "Step 2. Generating OWL code from Chowlk diagrams"
...
echo "Step 3. Generating ontology documentation using WIDOCO tool"
